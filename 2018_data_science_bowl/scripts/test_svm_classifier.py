...
class test_classifier( object ):
    ...
    def __init__( self, df_path, image_col_name, category_col_name, fixed_size, classifier_pkl,
        ...
        :param test_path: Path to the directories containing test images
        :param index_path: Path to the index file for the test directory
        ...
        self.data = self._load_test_data_from_dataframe(df_path)
    ...
    def _load_test_data_from_dataframe( self, df_path ):
